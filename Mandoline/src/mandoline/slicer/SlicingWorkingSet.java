...
public class SlicingWorkingSet extends ArrayDeque<Pair<StatementInstance, AccessPath>> {
    ...
    void addStmtOnly (StatementInstance si, Pair<StatementInstance, AccessPath> source, String edgeType){
    ...
    void addStmt(StatementInstance si, Pair<StatementInstance, AccessPath> source, String edgeType){
        Unit u = si.getUnit();
